...
mod escrow {
    ...
    impl Escrow {
        ...
        pub fn create_new_payment(
            ...
            //remove comments for enabling ERC20
        ...
        pub fn assess_audit(&mut self, id: u32, answer: bool) -> Result<()> {
            ...
            {
                //remove the comment and add this along with the answer in the if conditional below
                // && ink::env::call::build_call::<Environment>()
                //         .call(self.stablecoin_address)
                //         .gas_limit(0)
                //         .transferred_value(0)
                ...
                //if arbitersprovider is finally dissatisfied.
                    ...
                    // remove the true from below condition and replace it with:
        ...
        pub fn arbiters_extend_deadline(
                ...
                )
            {
                ...
                //remove comments for enabling ERC20
                //and remove the statements of x and y
                let x = true;
                let y = true;
        ...
        pub fn expire_audit(&mut self, id: u32) -> Result<()> {
            ...
            {
                payment_info.currentstatus = AuditStatus::AuditExpired;
                // remove the assumed true from below and insert the commented transfer condition
                // ink::env::call::build_call::<Environment>()
                //     .call(self.stablecoin_address)
                //     .gas_limit(0)
                //     .transferred_value(0)
...
mod test_cases {
    ...
    fn test_case_make_new_audit() {
        ...
        contract.create_new_payment(value, arbiter_provider, deadline);
    ...
    fn test_case_p1() {
        ...
        assert_eq!(contract.audit_id_to_payment_info.get(0).unwrap().currentstatus, AuditStatus::AuditCompleted);
    }
    ...
    fn test_case_p2 () {
        ...
        ink::env::test::set_caller::<ink::env::DefaultEnvironment>(accounts.alice);
        contract.assess_audit(0, false);
        assert_eq!(contract.audit_id_to_payment_info.get(0).unwrap().currentstatus, false);
